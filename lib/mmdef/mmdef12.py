...
#
# Generated Wed Aug 29 23:15:55 2012 by generateDS.py version 2.7c.
#
...
class malwareMetaData(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='malwareMetaData', fromsubclass_=False, pretty_print=True):
        ...
        if self.objectProperties is not None:
            self.objectProperties.export(outfile, level, namespace_, name_='objectProperties', pretty_print=pretty_print)
        ...
        if self.fieldData is not None:
            self.fieldData.export(outfile, level, namespace_, name_='fieldData', pretty_print=pretty_print)
...
class fileObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='fileObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.sha256 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssha256>%s</%ssha256>%s' % (namespace_, self.gds_format_string(quote_xml(self.sha256).encode(ExternalEncoding), input_name='sha256'), namespace_, eol_))
        if self.sha512 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%ssha512>%s</%ssha512>%s' % (namespace_, self.gds_format_string(quote_xml(self.sha512).encode(ExternalEncoding), input_name='sha512'), namespace_, eol_))
        ...
        if self.crc32 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scrc32>%s</%scrc32>%s' % (namespace_, self.gds_format_string(quote_xml(self.crc32).encode(ExternalEncoding), input_name='crc32'), namespace_, eol_))
        for fileType_ in self.fileType:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfileType>%s</%sfileType>%s' % (namespace_, self.gds_format_string(quote_xml(fileType_).encode(ExternalEncoding), input_name='fileType'), namespace_, eol_))
        for extraHash_ in self.extraHash:
            extraHash_.export(outfile, level, namespace_, name_='extraHash', pretty_print=pretty_print)
        ...
        for normalizedNativePath_ in self.normalizedNativePath:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snormalizedNativePath>%s</%snormalizedNativePath>%s' % (namespace_, self.gds_format_string(quote_xml(normalizedNativePath_).encode(ExternalEncoding), input_name='normalizedNativePath'), namespace_, eol_))
        for filenameWithinInstaller_ in self.filenameWithinInstaller:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfilenameWithinInstaller>%s</%sfilenameWithinInstaller>%s' % (namespace_, self.gds_format_string(quote_xml(filenameWithinInstaller_).encode(ExternalEncoding), input_name='filenameWithinInstaller'), namespace_, eol_))
        for folderWithinInstaller_ in self.folderWithinInstaller:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfolderWithinInstaller>%s</%sfolderWithinInstaller>%s' % (namespace_, self.gds_format_string(quote_xml(folderWithinInstaller_).encode(ExternalEncoding), input_name='folderWithinInstaller'), namespace_, eol_))
        ...
        for internalName_ in self.internalName:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sinternalName>%s</%sinternalName>%s' % (namespace_, self.gds_format_string(quote_xml(internalName_).encode(ExternalEncoding), input_name='internalName'), namespace_, eol_))
        ...
        if self.fileVersion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfileVersion>%s</%sfileVersion>%s' % (namespace_, self.gds_format_string(quote_xml(self.fileVersion).encode(ExternalEncoding), input_name='fileVersion'), namespace_, eol_))
        if self.productVersion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sproductVersion>%s</%sproductVersion>%s' % (namespace_, self.gds_format_string(quote_xml(self.productVersion).encode(ExternalEncoding), input_name='productVersion'), namespace_, eol_))
        if self.developmentEnvironment is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdevelopmentEnvironment>%s</%sdevelopmentEnvironment>%s' % (namespace_, self.gds_format_string(quote_xml(self.developmentEnvironment).encode(ExternalEncoding), input_name='developmentEnvironment'), namespace_, eol_))
        ...
        if self.buildTimeDateStamp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sbuildTimeDateStamp>%s</%sbuildTimeDateStamp>%s' % (namespace_, self.gds_format_string(quote_xml(self.buildTimeDateStamp).encode(ExternalEncoding), input_name='buildTimeDateStamp'), namespace_, eol_))
        if self.compilerVersion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scompilerVersion>%s</%scompilerVersion>%s' % (namespace_, self.gds_format_string(quote_xml(self.compilerVersion).encode(ExternalEncoding), input_name='compilerVersion'), namespace_, eol_))
        if self.linkerVersion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%slinkerVersion>%s</%slinkerVersion>%s' % (namespace_, self.gds_format_float(self.linkerVersion, input_name='linkerVersion'), namespace_, eol_))
        if self.minOSVersionCPE is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sminOSVersionCPE>%s</%sminOSVersionCPE>%s' % (namespace_, self.gds_format_string(quote_xml(self.minOSVersionCPE).encode(ExternalEncoding), input_name='minOSVersionCPE'), namespace_, eol_))
        ...
        if self.requiredPrivilege is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%srequiredPrivilege>%s</%srequiredPrivilege>%s' % (namespace_, self.gds_format_string(quote_xml(self.requiredPrivilege).encode(ExternalEncoding), input_name='requiredPrivilege'), namespace_, eol_))
        if self.digitalSignature is not None:
            self.digitalSignature.export(outfile, level, namespace_, name_='digitalSignature', pretty_print=pretty_print)
        if self.taggant is not None:
            self.taggant.export(outfile, level, namespace_, name_='taggant', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class registryObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='registryObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.valueName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%svalueName>%s</%svalueName>%s' % (namespace_, self.gds_format_string(quote_xml(self.valueName).encode(ExternalEncoding), input_name='valueName'), namespace_, eol_))
    def hasContent_(self):
        if (
...
class uriObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='uriObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.uriString is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%suriString>%s</%suriString>%s' % (namespace_, self.gds_format_string(quote_xml(self.uriString).encode(ExternalEncoding), input_name='uriString'), namespace_, eol_))
        ...
        if self.ipProtocol is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sipProtocol>%s</%sipProtocol>%s' % (namespace_, self.gds_format_string(quote_xml(self.ipProtocol).encode(ExternalEncoding), input_name='ipProtocol'), namespace_, eol_))
    def hasContent_(self):
        if (
...
class IPObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='IPObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.startAddress is not None:
            self.startAddress.export(outfile, level, namespace_, name_='startAddress', pretty_print=pretty_print)
        if self.endAddress is not None:
            self.endAddress.export(outfile, level, namespace_, name_='endAddress', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class ASNObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ASNObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.as_number is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sas-number>%s</%sas-number>%s' % (namespace_, self.gds_format_integer(self.as_number, input_name='as-number'), namespace_, eol_))
    def hasContent_(self):
        if (
...
class classificationObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='classificationObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.classificationName is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sclassificationName>%s</%sclassificationName>%s' % (namespace_, self.gds_format_string(quote_xml(self.classificationName).encode(ExternalEncoding), input_name='classificationName'), namespace_, eol_))
        ...
        if self.classificationDetails is not None:
            self.classificationDetails.export(outfile, level, namespace_, name_='classificationDetails', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class fieldDataEntry(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='fieldDataEntry', fromsubclass_=False, pretty_print=True):
        ...
        if self.firstSeenDate is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sfirstSeenDate>%s</%sfirstSeenDate>%s' % (namespace_, self.gds_format_string(quote_xml(self.firstSeenDate).encode(ExternalEncoding), input_name='firstSeenDate'), namespace_, eol_))
        ...
        if self.commonality is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scommonality>%s</%scommonality>%s' % (namespace_, self.gds_format_integer(self.commonality, input_name='commonality'), namespace_, eol_))
        for volume_ in self.volume:
            volume_.export(outfile, level, namespace_, name_='volume', pretty_print=pretty_print)
        if self.importance is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%simportance>%s</%simportance>%s' % (namespace_, self.gds_format_integer(self.importance, input_name='importance'), namespace_, eol_))
...
class softwarePackageObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='softwarePackageObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.productgroup is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sproductgroup>%s</%sproductgroup>%s' % (namespace_, self.gds_format_string(quote_xml(self.productgroup).encode(ExternalEncoding), input_name='productgroup'), namespace_, eol_))
        if self.product is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sproduct>%s</%sproduct>%s' % (namespace_, self.gds_format_string(quote_xml(self.product).encode(ExternalEncoding), input_name='product'), namespace_, eol_))
        ...
        if self.update is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%supdate>%s</%supdate>%s' % (namespace_, self.gds_format_string(quote_xml(self.update).encode(ExternalEncoding), input_name='update'), namespace_, eol_))
        if self.edition is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sedition>%s</%sedition>%s' % (namespace_, self.gds_format_string(quote_xml(self.edition).encode(ExternalEncoding), input_name='edition'), namespace_, eol_))
        ...
        if self.CPEname is not None:
            self.CPEname.export(outfile, level, namespace_, name_='CPEname', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.vendor is not None or
...
class digitalSignatureObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='digitalSignatureObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.certificateIssuer is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scertificateIssuer>%s</%scertificateIssuer>%s' % (namespace_, self.gds_format_string(quote_xml(self.certificateIssuer).encode(ExternalEncoding), input_name='certificateIssuer'), namespace_, eol_))
        if self.certificateSubject is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scertificateSubject>%s</%scertificateSubject>%s' % (namespace_, self.gds_format_string(quote_xml(self.certificateSubject).encode(ExternalEncoding), input_name='certificateSubject'), namespace_, eol_))
        if self.certificateValidity is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scertificateValidity>%s</%scertificateValidity>%s' % (namespace_, self.gds_format_boolean(self.gds_str_lower(str(self.certificateValidity)), input_name='certificateValidity'), namespace_, eol_))
        if self.certificateRevocationTimestamp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scertificateRevocationTimestamp>%s</%scertificateRevocationTimestamp>%s' % (namespace_, self.gds_format_string(quote_xml(self.certificateRevocationTimestamp).encode(ExternalEncoding), input_name='certificateRevocationTimestamp'), namespace_, eol_))
        if self.signingTimestamp is not None:
            self.signingTimestamp.export(outfile, level, namespace_, name_='signingTimestamp', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class taggantObject(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='taggantObject', fromsubclass_=False, pretty_print=True):
        ...
        if self.taggantValidity is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%staggantValidity>%s</%staggantValidity>%s' % (namespace_, self.gds_format_boolean(self.gds_str_lower(str(self.taggantValidity)), input_name='taggantValidity'), namespace_, eol_))
        if self.signingTimestamp is not None:
            self.signingTimestamp.export(outfile, level, namespace_, name_='signingTimestamp', pretty_print=pretty_print)
    def hasContent_(self):
        if (
...
class objectsType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='objectsType', fromsubclass_=False, pretty_print=True):
        ...
        for registry_ in self.registry:
            registry_.export(outfile, level, namespace_, name_='registry', pretty_print=pretty_print)
        for ip_ in self.ip:
            ip_.export(outfile, level, namespace_, name_='ip', pretty_print=pretty_print)
        for asn_ in self.asn:
            asn_.export(outfile, level, namespace_, name_='asn', pretty_print=pretty_print)
        ...
        for softwarePackage_ in self.softwarePackage:
            softwarePackage_.export(outfile, level, namespace_, name_='softwarePackage', pretty_print=pretty_print)
        for digitalSignature_ in self.digitalSignature:
            digitalSignature_.export(outfile, level, namespace_, name_='digitalSignature', pretty_print=pretty_print)
        for taggant_ in self.taggant:
            taggant_.export(outfile, level, namespace_, name_='taggant', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.file or
            self.uri or
...
class objectPropertiesType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='objectPropertiesType', fromsubclass_=False, pretty_print=True):
        ...
        for objectProperty_ in self.objectProperty:
            objectProperty_.export(outfile, level, namespace_, name_='objectProperty', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.objectProperty
            ):
...
class fieldDataType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='fieldDataType', fromsubclass_=False, pretty_print=True):
        ...
        for fieldDataEntry_ in self.fieldDataEntry:
            fieldDataEntry_.export(outfile, level, namespace_, name_='fieldDataEntry', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.fieldDataEntry
            ):
...
class classificationDetailsType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='classificationDetailsType', fromsubclass_=False, pretty_print=True):
        ...
        if self.definitionVersion is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdefinitionVersion>%s</%sdefinitionVersion>%s' % (namespace_, self.gds_format_string(quote_xml(self.definitionVersion).encode(ExternalEncoding), input_name='definitionVersion'), namespace_, eol_))
        if self.detectionAddedTimeStamp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetectionAddedTimeStamp>%s</%sdetectionAddedTimeStamp>%s' % (namespace_, self.gds_format_string(quote_xml(self.detectionAddedTimeStamp).encode(ExternalEncoding), input_name='detectionAddedTimeStamp'), namespace_, eol_))
        if self.detectionShippedTimeStamp is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdetectionShippedTimeStamp>%s</%sdetectionShippedTimeStamp>%s' % (namespace_, self.gds_format_string(quote_xml(self.detectionShippedTimeStamp).encode(ExternalEncoding), input_name='detectionShippedTimeStamp'), namespace_, eol_))
        if self.product is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sproduct>%s</%sproduct>%s' % (namespace_, self.gds_format_string(quote_xml(self.product).encode(ExternalEncoding), input_name='product'), namespace_, eol_))
        if self.productVersion is not None:
...
class signingTimestampType(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='signingTimestampType', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='signingTimestampType')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
...
class signingTimestampType1(GeneratedsSuper):
    ...
    def export(self, outfile, level, namespace_='', name_='signingTimestampType1', namespacedef_='', pretty_print=True):
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='signingTimestampType1')
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from mmdef12 import *\n\n')
    sys.stdout.write('import mmdef12 as model_\n\n')
